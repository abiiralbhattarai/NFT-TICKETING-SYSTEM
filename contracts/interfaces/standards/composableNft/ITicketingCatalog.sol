...
/**
 * @title ITicketingCatalog
 *
 * @notice An interface Catalog for Ticketing equippable module.
 */
interface ITicketingCatalog is IERC165Upgradeable {
    /**
    ...
    /**
     * @notice The integral structure of a standard Ticketing catalog item defining it.
