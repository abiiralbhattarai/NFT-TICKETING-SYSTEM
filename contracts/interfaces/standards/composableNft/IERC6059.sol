...
/**
 * @title IERC6059
 * @notice Interface smart contract of the Ticketing nestable module.
 */
interface IERC6059 is IERC165Upgradeable {
    /**
     * @notice The core struct of Ticketing ownership.
     ...
     * @param tokenId ID of the token for which the Ticketing owner is being retrieved
