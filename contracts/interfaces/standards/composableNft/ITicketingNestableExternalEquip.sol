...
/**
 * @title ITicketingNestableExternalEquip
 *
 * @notice Interface smart contract of the Ticketing nestable with external equippable module.
 */
interface ITicketingNestableExternalEquip is IERC165Upgradeable {
    /**
