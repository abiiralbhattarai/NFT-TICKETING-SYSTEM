...
/**
 * @title IERC5773
 * @notice Interface smart contract of the  multi asset module.
 */
interface IERC5773 is IERC165Upgradeable {
  /**
   ...
   */
  function setPriority(uint256 tokenId, uint64[] calldata priorities) external;
