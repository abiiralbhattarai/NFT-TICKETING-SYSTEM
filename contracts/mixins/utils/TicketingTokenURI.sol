...
/**
 * @title TicketingTokenURI
 *
 * @notice Implementation of token URI with option to be enumerable.
 */
contract TicketingTokenURI is Initializable {
    ...
    function __TicketingTokenURI_init(
        string memory tokenURI_,
        bool isEnumerable
    ) internal onlyInitializing {
        __TicketingTokenURI_init_unchained(tokenURI_, isEnumerable);
    }
     ...
     *  the base when getting the tokenURI
     */
    function __TicketingTokenURI_init_unchained(
        string memory tokenURI_,
        bool isEnumerable
    ) internal onlyInitializing {
