...
/**
 * @title TicketingNestableRenderUtils
 * @author Ticketing team
 * @notice Smart contract of the Ticketing Nestable render utils module.
 */
contract TicketingNestableRenderUtils {
    /**
    ...
    function getChildIndex(
        ...
        revert TicketingChildNotFoundInParent();
    }
    ...
    function getParent(
        ...
        if (!isNFT) revert TicketingParentIsNotNFT();
    }
    ...
    function checkExpectedParent(
        ...
        if (parentAddress != expectedParent || expectedParentId != parentId)
            revert TicketingUnexpectedParent();
    }
    ...
    function validateChildrenOf(
        ...
        if (childAddresses.length != childIds.length) {
            revert TicketingMismachedArrayLength();
        }
