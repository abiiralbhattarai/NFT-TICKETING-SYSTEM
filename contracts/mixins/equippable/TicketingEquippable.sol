...
import "../nestable/TicketingNestable.sol";
import "../security/ReentrancyGuard.sol";

/**
 * @title TicketingEquippable
 *
 * @notice Smart contract of the Ticketing Equippable module.
 */
contract TicketingEquippable is
    TicketingNestable,
    AbstractMultiAsset,
    ReentrancyGuard,
    IERC6220
{
    ...
    function __TicketingEquippable_init(
        string memory name_,
        string memory symbol_
    ) internal onlyInitializing {
        __TicketingEquippable_init_unchained(name_, symbol_);
    }
     ...
     * @param symbol_ Symbol of the token collection
     */
    function __TicketingEquippable_init_unchained(
        string memory name_,
        string memory symbol_
    ) internal onlyInitializing {
    ...
    {
        return
            TicketingNestable.supportsInterface(interfaceId) ||
